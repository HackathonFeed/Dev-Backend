...
PLAN_CATALOGUE: list[PlanInfo] = [
    ...
    PlanInfo(
        ...
        messages_per_cycle="100 AI messages / month",
        features=[
            "500 AI copilot points / month",
            "Everything in Hacker",
            "Priority hackathon alerts",
            "AI idea validator (unlimited)",
            "Monthly points auto-refresh",
        ],
    ),
    PlanInfo(
        ...
        messages_per_cycle="Unlimited AI messages",
        features=[
